...
- 2026-03-19: `uv run pytest .codex/skills/openharness/tests/test_openharness.py` passed after vendoring repository skills into `.codex/skills/`, removing the wrong-root plan artifact under `docs/superpowers/plans/`, and switching the harness test from symlink enforcement to local-skill enforcement.
- 2026-03-19: `uv run python .codex/skills/openharness/scripts/openharness.py check-designs` passed after updating repository-local planning and brainstorming skills to default to `docs/designs/<task>/` instead of `docs/superpowers/...`.
