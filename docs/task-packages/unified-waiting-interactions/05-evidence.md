...
- `docs/task-packages/unified-waiting-interactions/04-verification.md`
- `docs/task-packages/unified-waiting-interactions/05-evidence.md`
...
- 2026-03-26:
  ...
  - 定向验证：`uv run pytest tests/feishu/test_streaming_content.py tests/feishu/test_reply_card.py tests/presentation/test_live_turn_presenter.py`
  - 当时仓库验证仍指向旧入口；该问题已在 2026-03-27 切换到全局 `openharness` 命令并完成 active package 迁移。
- 2026-03-26:
  ...
  - 当时仓库验证仍因旧入口和旧编号未迁移而失真；当前 active package 已改为新版结构。
