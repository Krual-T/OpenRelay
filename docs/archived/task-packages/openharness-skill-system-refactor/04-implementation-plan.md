...
- Modify: `docs/archived/task-packages/openharness-skill-system-refactor/03-detailed-design.md`
...
```bash
git add .agents/skills/openharness docs/archived/task-packages/openharness-skill-system-refactor/03-detailed-design.md
...
**Files:**
- Modify: `docs/archived/task-packages/openharness-skill-system-refactor/04-implementation-plan.md`
- Modify: `docs/archived/task-packages/openharness-skill-system-refactor/05-verification.md`
- Modify: `docs/archived/task-packages/openharness-skill-system-refactor/06-evidence.md`
- Modify: `docs/archived/task-packages/openharness-skill-system-refactor/STATUS.yaml`
...
```bash
git add docs/archived/task-packages/openharness-skill-system-refactor .project-memory .agents/skills/openharness
