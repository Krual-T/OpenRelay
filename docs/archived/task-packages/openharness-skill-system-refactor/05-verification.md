...
- `2026-03-20`: package archived under `docs/archived/task-packages/openharness-skill-system-refactor/`, `check-tasks` re-passed, and default `bootstrap` no longer lists OR-019 as active.
