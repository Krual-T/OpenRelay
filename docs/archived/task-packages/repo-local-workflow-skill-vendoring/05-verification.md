...
- `2026-03-20`: package archived under `docs/archived/task-packages/repo-local-workflow-skill-vendoring/`, `check-tasks` re-passed, and default `bootstrap` no longer lists OR-020 as active.
