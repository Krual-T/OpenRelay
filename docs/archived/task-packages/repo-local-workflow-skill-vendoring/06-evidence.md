...
- `docs/archived/task-packages/repo-local-workflow-skill-vendoring/04-implementation-plan.md`
- `docs/archived/task-packages/repo-local-workflow-skill-vendoring/05-verification.md`
- `docs/archived/task-packages/repo-local-workflow-skill-vendoring/06-evidence.md`
- `docs/archived/task-packages/repo-local-workflow-skill-vendoring/STATUS.yaml`
- `docs/archived/task-packages/openharness-skill-system-refactor/STATUS.yaml`
