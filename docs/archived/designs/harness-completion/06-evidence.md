...
- `apply_patch` to remove legacy entry-layer names from `.agents/skills/openharness/using-openharness/SKILL.md`, `.agents/skills/openharness/using-openharness/references/skill-hub.md`, and `docs/archived/designs/harness-completion/*`
