...
- `docs/archived/designs/harness-skill-relative-paths/README.md`
- `docs/archived/designs/harness-skill-relative-paths/STATUS.yaml`
- `docs/archived/designs/harness-skill-relative-paths/01-requirements.md`
- `docs/archived/designs/harness-skill-relative-paths/02-overview-design.md`
- `docs/archived/designs/harness-skill-relative-paths/03-detailed-design.md`
- `docs/archived/designs/harness-skill-relative-paths/04-implementation-plan.md`
- `docs/archived/designs/harness-skill-relative-paths/05-verification.md`
- `docs/archived/designs/harness-skill-relative-paths/06-evidence.md`
...
- `! rg -n "\.codex/skills/openharness|uv run python .*openharness\.py" AGENTS.md docs .project-memory -S -g '!docs/archived/designs/harness-skill-relative-paths/**' -g '!docs/archived/designs/harness-skill-relative-paths/**'`
