...
- Modify: `docs/archived/designs/repo-local-workflow-skill-vendoring/05-verification.md`
- Modify: `docs/archived/designs/repo-local-workflow-skill-vendoring/06-evidence.md`
- Modify: `docs/archived/designs/repo-local-workflow-skill-vendoring/STATUS.yaml`
...
- [ ] Run `check-designs` and the repo-local harness tests.
