...
## Files
- `docs/archived/legacy/task-packages/harness-completion/README.md`
- `docs/archived/legacy/task-packages/harness-completion/STATUS.yaml`
- `docs/archived/legacy/task-packages/harness-completion/01-requirements.md`
- `docs/archived/legacy/task-packages/harness-completion/02-overview-design.md`
- `docs/archived/legacy/task-packages/harness-completion/03-detailed-design.md`
- `docs/archived/legacy/task-packages/harness-completion/05-verification.md`
- `docs/archived/legacy/task-packages/harness-completion/06-evidence.md`
- `docs/archived/legacy/task-packages/message-observability/`
- `docs/archived/legacy/task-packages/architecture-refactor/`
...
- `apply_patch` to remove legacy entry-layer names from `.agents/skills/openharness/using-openharness/SKILL.md`, `.agents/skills/openharness/using-openharness/references/skill-hub.md`, and `docs/archived/legacy/task-packages/harness-completion/*`
- `python` repository-wide scan for the legacy brand token and its former entry-skill alias
- `apply_patch` to archive `docs/archived/legacy/task-packages/harness-completion/` by setting `STATUS.yaml.status` to `archived` and updating package verification notes
- `.agents/skills/openharness/using-openharness/scripts/openharness.py check-tasks`
- `pytest .agents/skills/openharness/using-openharness/tests/test_openharness.py`

## Follow-ups
- This package now lives under `docs/archived/legacy/task-packages/harness-completion/`; later work should keep the docs-root layout canonical.
