...
## Migration Notes
- Migrate the current `designs/harness-foundation/` package into `docs/archived/legacy/task-packages/harness-foundation/`.
...
- `docs/archived/legacy/or-task-007-message-observability-design.md`
  ...
  - target package: `docs/archived/legacy/task-packages/message-observability/`
...
- `docs/archived/legacy/or-task-009-architecture-refactor-overall-design.md`
  - class: `migrate-existing-design`
  - target package: `docs/archived/legacy/task-packages/architecture-refactor/`
  - package role: `02-overview-design.md`
...
- `OR-TASK-016`
  ...
  - target package: `docs/archived/legacy/task-packages/harness-completion/`
- `OR-TASK-017`
