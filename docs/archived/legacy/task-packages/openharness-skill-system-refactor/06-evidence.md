...
- `docs/archived/legacy/task-packages/openharness-skill-system-refactor/04-implementation-plan.md`
- `docs/archived/legacy/task-packages/openharness-skill-system-refactor/05-verification.md`
- `docs/archived/legacy/task-packages/openharness-skill-system-refactor/06-evidence.md`
