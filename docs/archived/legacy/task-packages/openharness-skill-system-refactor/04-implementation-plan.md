...
- Modify: `docs/archived/legacy/task-packages/openharness-skill-system-refactor/03-detailed-design.md`
...
```bash
git add .agents/skills/openharness docs/archived/legacy/task-packages/openharness-skill-system-refactor/03-detailed-design.md
...
**Files:**
- Modify: `docs/archived/legacy/task-packages/openharness-skill-system-refactor/04-implementation-plan.md`
- Modify: `docs/archived/legacy/task-packages/openharness-skill-system-refactor/05-verification.md`
- Modify: `docs/archived/legacy/task-packages/openharness-skill-system-refactor/06-evidence.md`
- Modify: `docs/archived/legacy/task-packages/openharness-skill-system-refactor/STATUS.yaml`
- Create or Modify: `.project-memory/facts/openharness_completion_contract.yaml`
- Test: `uv run .agents/skills/openharness/using-openharness/scripts/openharness.py check-tasks --repo .`
...
```bash
git add docs/archived/legacy/task-packages/openharness-skill-system-refactor .project-memory .agents/skills/openharness
