...
- After that handoff, `openrelay` starts a new top-level streaming card and continues live output there.
...
- If a turn outlives one streaming window, users will see a new top-level continuation card instead of a frozen spinner.
