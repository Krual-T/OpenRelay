...
如果你想直接让 Codex 代你安装，直接把这个文件的 URL 发给它即可，推荐使用 raw 链接：

```text
Help me install this project into the xx directory. https://raw.githubusercontent.com/Krual-T/OpenRelay/main/INSTALL.md
```
